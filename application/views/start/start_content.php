    ...
    <div class="carousel-inner rounded">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption">
                <a href="<?= base_url('/silvester'); ?>" class="stretched-link"></a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="<?= base_url('/attraktion/bowling'); ?>" class="stretched-link"></a>
            </div>
        </div>
        <div class="carousel-item">
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="<?= base_url('/attraktion/escaperoom'); ?>" class="stretched-link"></a>
            </div>
        </div>
        <div class="carousel-item">
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="<?= base_url('/attraktion/minigolf'); ?>" class="stretched-link"></a>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="/assets/images/slider_fotos spielcenter_minigolf.png" alt="Minigolf Chemnitz">
            <div class="carousel-caption">
                <a href="<?= base_url('/attraktion/minigolf'); ?>" class="stretched-link"></a>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="/assets/images/slider_fotos spielcenter_minigolf2.png" alt="Minigolf Chemnitz">
            <div class="carousel-caption">
                <a href="<?= base_url('/attraktion/minigolf'); ?>" class="stretched-link"></a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption">
                ...
                <a href="<?= base_url('/attraktion/lasertag'); ?>" class="stretched-link"></a>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="/assets/images/slider_fotos spielcenter_lasertag.png" alt="Lasergame Chemnitz">
            <div class="carousel-caption">
                <a href="<?= base_url('/attraktion/lasertag'); ?>" class="stretched-link"></a>
            </div>
        </div>
